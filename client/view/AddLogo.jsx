...
import AddLogoMain from '../components/blocks/AddLogoMain';
import AddLogoFormContainer from '../containers/AddLogoFormContainer';
  ...
  render() {
    ...
    return (
      <div className={`wrapper ${this.state.visible ? '' : 'load'}`}>
        ...
        <AddLogoMain />
        <AddLogoFormContainer onSubmit={values => {
          return this.props.logoCreate(values);
        }} />
        <FooterContainer />
      </div>
    );
